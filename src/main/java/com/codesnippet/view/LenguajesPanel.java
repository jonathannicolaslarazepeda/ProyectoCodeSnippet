...
public class LenguajesPanel extends JPanel {
    ...
    private void crearFormulario() {
        ...
        panel.setBorder(BorderFactory.createTitledBorder("Datos de lenguajes"));
    ...
    private void guardar() {
        try {
            Lenguaje obj = new Lenguaje(txtNombre.getText(), txtDescripcion.getText()); obj.setId(idSeleccionado);
    ...
    private void cargarTabla() {
        ...
        for (Lenguaje o : lista) { modelo.addRow(new Object[]{o.getId(), o.getNombre(), o.getDescripcion()}); }
    }
